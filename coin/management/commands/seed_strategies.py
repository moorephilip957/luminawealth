...
class Command(BaseCommand):
    help = "Create test AI trading strategies and historical spin records"
    ...
    def handle(self, *args, **options):
        ...
        if not admin:
            raise Exception(
                "No staff/superuser found. Create one first."
            )
        ...
        strategies = [
            {
                ...
                "description": (
                    "An AI-assisted trading strategy designed to analyze "
                    "market trends and identify high-probability opportunities."
                ),
            ...
            },
            {
                ...
                "description": (
                    "An intelligent trading strategy that uses AI-driven "
                    "market analysis to help navigate changing market conditions."
                ),
            ...
            },
            {
                ...
                "description": (
                    "AI-assisted trading technology designed to identify "
                    "market momentum and potential profit opportunities."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A smart AI trading strategy that continuously analyzes "
                    "market activity to support informed trading decisions."
                ),
            ...
            },
            {
                ...
                "description": (
                    "AI-powered trend analysis strategy designed to follow "
                    "market momentum and react to changing conditions."
                ),
            ...
            },
            {
                ...
                "description": (
                    "An AI-assisted strategy focused on combining market "
                    "intelligence with disciplined trading for long-term growth."
                ),
            ...
            },
            {
                ...
                "description": (
                    "An AI-driven trading strategy built to scan market "
                    "movements and identify emerging trading opportunities."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A forward-looking AI trading strategy that analyzes "
                    "market signals to help identify potential opportunities."
                ),
            ...
            },
            {
                ...
                "description": (
                    "An advanced AI-assisted strategy designed to capture "
                    "market momentum and respond to significant price movements."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A premium AI-assisted trading strategy combining market "
                    "signals, trend analysis and intelligent portfolio positioning."
                ),
        ...
        for index, data in enumerate(strategies):
            ...
            self.stdout.write(
                f"\n{action_text}: {strategy.name}"
            )

            # ========================================================
            # REMOVE OLD SPINS FOR THIS STRATEGY
            # ========================================================
            ...
            for spin_number in range(1, 11):
                ...
                # ====================================================
                #
                # Spin 1  -> approximately 45 hours ago
                # Spin 2  -> approximately 40 hours ago
                # ...
                # Spin 10 -> approximately 1 hour ago
                #
                # This gives the chart a proper historical timeline.
                # ====================================================
                ...
                spin = SpinRecord.objects.create(
                    ...
                    reason="AI market analysis adjustment",
                    notes=(
                        f"Historical AI trading movement "
                        f"#{spin_number}"
                    ),
                    ip_address=None,
                ...
                # ====================================================
                #
                # Your model has auto_now_add=True, so Django ignores
                # created_at during .create(). We update it afterwards.
                # ====================================================
            ...
            # ========================================================
            # SET STRATEGY TO FINAL SPIN PRICE
            # ========================================================
        ...
        strategy_count = Strategy.objects.filter(
            name__in=[
                item["name"] for item in strategies
            ]
        ).count()

        spin_count = SpinRecord.objects.filter(
            strategy__name__in=[
                item["name"] for item in strategies
            ]
        ).count()
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "AI STRATEGY TEST DATA CREATED SUCCESSFULLY"
            )
        )
        ...
        self.stdout.write(
            f"Expected spins: {len(strategies) * 10}"
        )
